...
const MainCard = ({ src, handleHeartClick, choiceFavorites }) => {
  ...
  return (
    <div className="main-card">
      ...
      />
      <button onClick={handleHeartClick}>{heartIcon}{choiceFavorites || null}</button>
    </div>
  );
};
...
const App = () => {
  ...
  const [mainFood, setMainFood] = useState(foodOne);
  ...
  //하트버튼
  const choiceFavorites = favorites.includes((favorites));
